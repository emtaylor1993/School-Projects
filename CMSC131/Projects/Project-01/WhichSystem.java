...
public class WhichSystem {
	 ...
	 * machine to do the task you report you
	 * want to do. 
					...
					if (compProcesses > 0) {
						...
						if (compProcesses * numUsers >= 1) {
							if (compProcesses * numUsers <= 30) {
								int numUnits = 1;
								System.out.println("On " + compSystem + " with " + numUsers + " users each running " + compProcesses + " processes, you will need " + numUnits + " units of memory." );
							}
						}
