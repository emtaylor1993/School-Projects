 ...
 * CMSC131, Section 0102
 * February 18, 2012
 * 
 * @packages
 * Java Abstract Window Toolkid (Color)
 */
...
public class LetterMaker {
	...
	public static void drawLetter(DrawingGrid grid, String letter, Color color) {
		// Stores the size of the grid the user chose inside a variable called size.
		int size = grid.getGridSize();
		
		// Paints the 3 by 3 square in the bottom right corner for an invalid letter choice.
