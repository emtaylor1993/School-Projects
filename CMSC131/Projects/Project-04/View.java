...
public class View extends JPanel {
	...
	private Rectangle recentMouseRectangle = null;
		...
		if (drawingProgress >= 0) {   // busy drawing
			...
			/* If user is currently dragging, draw the rectangle */
				...
				if (recentMouseRectangle != null) {
					g.fillRect((int)recentMouseRectangle.getX(), (int)recentMouseRectangle.getY(), (int)recentMouseRectangle.getWidth(), (int)recentMouseRectangle.getHeight());
				}
