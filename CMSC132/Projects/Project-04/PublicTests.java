...
public class PublicTests {
    ...
    @Test public void testPublic4() {
        ...
        String[] result s = {"O", "", "", "E F", "", "", "", "", "", "", "", "B K", "A N", "C G", "H", "D"};
        Character ch;
        int i;
        ...
        for (ch = 'A', i = 0; ch <= 'P'; ch++, i++)
            assertEquals(results[i], TestGraphs.iterableToString(graph.getNeighbors(ch)));
        } 
    ...
    @Test public void testPublic5() {
        Graph<Character> graph = TestGraphs.testGraph2();
        String[] results = {"O", "", "", "E F", "", "", "", "", "", "", "", "B K", "A N", "C G", "H", "D"};
        ...
        for (Character ch : graph)
            assertEquals(results[ch - 'A'], TestGraphs.iterableToString(graph.getNeighbors(ch)));
    }
    ...
    @Test public void testPublic6() {
        ...
        for (i = 0; i <= 4; i++)
            assertEquals(results[i], TestGraphs.iterableToString(graph.getNeighbors(i)));
    }
    ...
    @Test public void testPublic15() {
        ...
        assertEquals("131 330 132 141", TestGraphs.getPath(shortestPath.getPath()));
    }
    ...
    @Test public void testPublic16() {
        ...
        assertEquals("250 351 132 141", TestGraphs.getPath(shortestPath.getPath()));
    }
}