...
usage -auto
set log file fv/ccu/rtl_to_g1.log -replace
// tclmode
// set env(CDN_SYNTH_ROOT) /dept/enee/software/cadenceIC6/linux/inst/EDI/tools.lnx86
// vpxmode

tclmode
puts "Start: Reading OVF file"
vpx read guide file fv/ccu/rtl_to_g1.ovf
...
add search path -library /homes/etaylor5/enee408c_user/labs/lab08/verilog/ccu/syn/
read library -statetable -liberty -pg_pin -both  \
	saed90nm_typ.lib

add search path -design /homes/etaylor5/enee408c_user/labs/lab08/verilog/ccu/syn/
read design  -verilog -define SYNTHESIS  -golden -lastmod -noelab \
	/homes/etaylor5/enee408c_user/labs/lab08/verilog/ccu/syn/counter.v

read design  -verilog2k -define SYNTHESIS  -golden -lastmod -noelab \
	/homes/etaylor5/enee408c_user/labs/lab08/verilog/ccu/syn/mux.v

read design  -verilog -define SYNTHESIS  -golden -lastmod -noelab \
	/homes/etaylor5/enee408c_user/labs/lab08/verilog/ccu/syn/adder.v

read design  -verilog -define SYNTHESIS  -golden -lastmod -noelab \
	/homes/etaylor5/enee408c_user/labs/lab08/verilog/ccu/syn/ccu.v

elaborate design -golden -root ccu

read design -verilog -revised -lastmod -noelab \
	-unzip fv/ccu/g1.v.gz

elaborate design -revised -root ccu
